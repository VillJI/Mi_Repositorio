...
class Lacteo extends Producto implements Fecha {
	...
	public static void crearLacteo() 
	{
        ...
        try 
        {
            ...
            LocalDate fechaFabricacion = validarFecha("fecha de fabricación");
            LocalDate fechaVencimiento = validarFecha("fecha de vencimiento");
	...
	public static LocalDate validarFecha(String tipoFecha) throws DateTimeException 
	{
        Scanner entrada = new Scanner(System.in);
